...
//        }
    ...
    private void OnGUI2()
    {
        ...
        if (GUI.Button(new Rect(240, 300, 100, 60), "hidebanner")) Admob.Instance().removeBanner();
    }
    ...
    private void onInterstitialEvent(string eventName, string msg)
    {
        ...
        if (eventName == AdmobEvent.onAdClosed) Admob.Instance().loadInterstitial();
    }
